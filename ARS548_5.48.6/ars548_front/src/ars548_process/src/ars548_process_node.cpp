...
int main(int argc, char **argv)
{
    ...
    ros::init(argc, argv, "ars548_process_front_node");
    ros::NodeHandle nh;
    ...
    status_pub = nh.advertise<ars548_msg::RadarBasicStatus>("/ars548_process_front/radar_Front_status", 10);
    objects_pub = nh.advertise<ars548_msg::ObjectList>("/ars548_process_front/object_Front_list", 10);
    detections_pub = nh.advertise<ars548_msg::DetectionList>("/ars548_process_front/detection_Front_list", 10);
