...
void receiveThread()
{
    while (ros::ok())
    {
        ...
        if (rec_length > 0 && source_address.sin_addr.s_addr == Radar_Side)
        {
...
int main(int argc, char **argv)
{
    ...
    ros::init(argc, argv, "ars548_process_side_node");
    ros::NodeHandle nh;
    ...
    status_pub = nh.advertise<ars548_msg::RadarBasicStatus>("/ars548_process_side/radar_side_status", 10);
    objects_pub = nh.advertise<ars548_msg::ObjectList>("/ars548_process_side/object_side_list", 10);
    detections_pub = nh.advertise<ars548_msg::DetectionList>("/ars548_process_side/detection_side_list", 10);
